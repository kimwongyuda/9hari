        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div className={style.box}>
                    <span className={style.text2} style={{fontSize: '20px', color: '#005bab'}}>주소 및 연락처</span>
                </div>

                <table className={style.table}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>주소</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>경기 용인시 기흥구 마북동 109<br></br>(우) 16910, (지번) 마북동 240-6</td>
                                </tr>
                                <tr>
                                    <td className={style.td+' '+style.text2} rowSpan='1'>연락처</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>070-4238-0191</td>
                                </tr>
                        </tbody>
                </table>
                ...
                <div className={style.box}>
                    <span className={style.text2} style={{fontSize: '20px', color: '#005bab'}}>교회 차량 안내</span>
                </div>
            ...
            <div>
                ...
                <table className={style.table}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>주소</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>경기 용인시 기흥구 마북동 109</td>
                                </tr>
                                <tr>
                                    <td className={style.td+' '+style.text2} rowSpan='1'>연락처</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>070-4238-0191</td>
