                ...
                <div className={style.toolbar} style={{backgroundColor: 'rgb(80, 80, 80)'}}>
                    <div className={style.navbar} style={{marginTop: '30px', marginBottom: '30px', height: '150px'}}>
                        <div style={{width: '100%', float: 'left', marginTop: '30px'}}>
                            ...
                            <span className={style.textb} style={{color: 'white', fontSize: '20px', marginRight: '20px'}}>구하리교회</span>
                            <span className={style.textb2} style={{color: 'white', fontSize: '20px', marginRight: '5px'}}>주소</span>
                            <span className={style.textb} style={{color: 'white', fontSize: '20px', marginRight: '20px'}}>경기 용인시 기흥구 마북동 109</span>
