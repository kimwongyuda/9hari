...
class Pagination extends Component{
    ...
    render(){
        ...
        const pagef1 = (<div>
            { pageint < inputcount+1 ? <Link to ={`/suggest/${cur_page_index}/1`} className={style.link2}><span className={style.smallbox2}>{'<'}</span></Link>
            : <Link to ={`/suggest/${cur_page_index}/${pageint-inputcount}`} className={style.link2}><span className={style.smallbox2}>{'<'}</span></Link>}</div>)

        const pagef2 = (<div>
            { pageint > maxpage-(inputcount+1) ? <Link to ={`/suggest/${cur_page_index}/${maxpage}`} className={style.link2}><span className={style.smallbox2}>{'>'}</span></Link>
            : <Link to ={`/suggest/${cur_page_index}/${pageint+inputcount}`} className={style.link2}><span className={style.smallbox2}>{'>'}</span></Link>}</div>)

        const pagilist = pagination.map((value, index) => (
            <div>
            {page == String(value) ? 
            <Link to ={`/suggest/${cur_page_index}/${value}`} className={style.link2}><span className={style.smallbox} style={{backgroundColor: '#DCDCDC'}}>{value}</span></Link>
        : <Link to ={`/suggest/${cur_page_index}/${value}`} className={style.link2}><span className={style.smallbox}>{value}</span></Link>
        }
        </div>
        ));
        ...
        const posts_show = posts_list.map((item, index) => (
            ...
            <div>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3}>{inputcount*(maxpage-pageint) + (posts_list.length-index)}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3} style={{textAlign: 'left', width: '35%'}}>{item.title.substr(0,18)}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3}>{item.name}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3}>{item.creation_date.substr(0,10)}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3} style={{width: '10%'}}>{item.views}</span></Link>
            {
                (()=>{
            ...
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3} style={{borderBottom: '0.1px solid #DCDCDC'}}>{item.name}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3} style={{borderBottom: '0.1px solid #DCDCDC'}}>{item.creation_date.substr(0,10)}</span></Link>
            <Link onClick={() => this.warpfunc(inputcount*(maxpage-pageint) + (posts_list.length-index))} to ={`/suggest/${cur_page_index}/${pageint}/${inputcount*(maxpage-pageint) + (posts_list.length-index)}`} className={style.tablelink}><span className={style.smallbox3} style={{borderBottom: '0.1px solid #DCDCDC', width: '10%'}}>{item.views}</span></Link>
            {
                (()=>{
                    if(writer_id == item.writer_id)
                    {
        ...
        return(
            ...
            <div style={{width: '100%', float: 'left'}}>
                ...
                {(()=>{
                    ...
                    if(this.state.posts[posts_size-sermon_num]!=undefined)
                    {
                        return <div>
                            ...
                            <div style={{width: '100%', float: 'left'}}>
                            <Link to={`/suggest/${cur_page_index}/${pageint}`} onClick={this.change_false} className={style.tablelink}><span className={style.smallbox3} style={{borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC'}}>목록으로</span></Link>
                            </div>
                            </div>
                    }
                    else
                ...
                <div>
                    ...
                    {pagef1}
                    <Link to ={`/suggest/${cur_page_index}/1`} className={style.link2}><span className={style.smallbox}>1</span></Link>
                    <span className={style.smallbox2}>...</span>
                    {pagilist}
                    <span className={style.smallbox2}>...</span>
                    <Link to ={`/suggest/${cur_page_index}/${maxpage}`} className={style.link2}><span className={style.smallbox}>{maxpage}</span></Link>
                    {pagef2}
                    </div>
                    ...
                    <div style={{width: '100%', float: 'left'}}>
                        <div style={{width: '50%', float: 'left', marginLeft: '25%', marginTop: '20px'}}>
                            ...
                            <Link to={`/suggest/${cur_page_index}/1`}><input type="image" src={dodbogi} style={{width: '40px', objectFit: 'fill'}} onClick={this.search}></input></Link>
                        </div>
                    </div>
                </div>
            </div>
