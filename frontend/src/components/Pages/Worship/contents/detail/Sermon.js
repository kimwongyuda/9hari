        ...
        return(
            <div key={this.state.data} style={{width: '100%', float: 'left'}}>
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                    ...
                    <span className={style.smallbox3+' '+ style.text} style={{width:'50%', textAlign: 'right'}}>{this.state.data.views}</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'100%', textAlign: 'center'}}>{this.state.data.content}</span>
                </div>
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px', marginTop: '30px'}}>
                    <span className={style.smallbox3+' '+ style.text2} style={{width:'30%', textAlign: 'right', paddingRight: '10px'}}>설교 제목</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'70%', textAlign: 'left'}}>{this.state.data.sermon_title}</span>
                    <span className={style.smallbox3+' '+ style.text2} style={{width:'30%', textAlign: 'right', paddingRight: '10px'}}>설교자</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'70%', textAlign: 'left'}}>{this.state.data.sermon_person}</span>
                    <span className={style.smallbox3+' '+ style.text2} style={{width:'30%', textAlign: 'right', paddingRight: '10px'}}>설교 말씀</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'70%', textAlign: 'left'}}>{this.state.data.sermon_words}</span>
                    <span className={style.smallbox3+' '+ style.text2} style={{width:'30%', textAlign: 'right', paddingRight: '10px'}}>설교 장소</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'70%', textAlign: 'left'}}>{this.state.data.sermon_place}</span>
                    <span className={style.smallbox3+' '+ style.text2} style={{width:'30%', textAlign: 'right', paddingRight: '10px'}}>설교 날짜</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'70%', textAlign: 'left'}}>{this.state.data.creation_date.substr(0,10)}</span>
                    <span className={style.smallbox3+' '+ style.text} style={{width:'100%', textAlign: 'center'}}>{this.state.data.sermon_summary}</span>
                </div>     
