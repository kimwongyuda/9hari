        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width:'100%', float: 'left'}}>
                    <span className={style.textb2} style={{fontSize: '30px', color: '#005bab'}}>청년부 소개</span>
                    <table className={style.table} style={{width: '90%', marginLeft: '5%',marginRight: '5%', marginTop: '30px', float:'left'}}>
                            <tbody>
                                    <tr> 
                                        <td className={style.td+' '+style.textb2} rowSpan='1'>모임 시간</td>
                ...
                <div style={{width:'100%', float: 'left', marginBottom: '30px'}}>
                    ...
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <br></br>
                        <span className={style.textb2} style={{fontSize: '20px'}}>2) 하나님이 주신 복을 깨닫게 한다.</span>
                        <br></br>
                    ...
                    <div style={{width: '100%', float: 'left'}}>
                        ...
                        <br></br>
                        <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                            <span className={style.textb2} style={{fontSize: '25px', color: 'rgb(80, 80, 80)'}}>1) 신앙 세우기</span>
                            <br></br>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>1) 설교 중심으로 은혜 받은 말씀을 다시 모임을 통해 기억하고 삶에 적용하게 한다.</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>2) 하나님의 말씀을 체계 있게 배울 수 있게 한다.</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>3) 큐티 세미나를 열어서 삶 속에서 하나님의 말씀을 계속 공급받을 수 있게 한다.</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>4) 매 주 모임을 마칠 때 구체적인 기도제목을 정해서 함께 기도하고 기도제목을 서로 나누며 응원한다.</span>
                        </div>
                        <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                            <span className={style.textb2} style={{fontSize: '25px', color: 'rgb(80, 80, 80)'}}>2) 예배 세우기</span>
                            <br></br>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>1) 찬양팀 </span>
                            <br></br>
                        ...
                        <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                            ...
                            <br></br>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>1) 평일 모임 </span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>청년 일터 및 교회에서 멀리 거주하는 지역에 찾아가 함께 모여 식사하며 말씀을 나누고 기도한다.</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>대중적인 찬양팀 집회에 함께 참석하여 예배하고 교제한다.</span>
                            <br></br>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>2) 다양한 모임</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>예배 후 운동, 영화감상, 독서토론, 나들이 등을 통하여 교제를 풍성하고 활발하게 한다.</span>
                        </div>
                        <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                            <span className={style.textb2} style={{fontSize: '25px', color: 'rgb(80, 80, 80)'}}>4) 전도</span>
                            <br></br>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>1) 전도에 필요한 성경말씀, 전달방법, 복음제시, 중보기도 등의 교육을 실행한다.</span>
                            <br></br>
                            <span className={style.textb2} style={{fontSize: '20px'}}>2) 각 연령, 관심분야 등을 고려하여 세대에 맞는 전도를 계획하고 실행한다.</span>
                        </div>
                    </div>
                </div>
            ...
            content = 
            <div>
                <Pagination props={{type: '청년부', pageindex: 4}}></Pagination>
            </div>
        }
