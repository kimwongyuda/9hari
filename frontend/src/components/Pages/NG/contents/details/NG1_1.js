        ...
        if(page == '1'){
            ...
            <div>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%',marginRight: '5%', marginTop: '30px', float:'left'}}>
                            <tbody>
                                    ...
                                    <tr> 
                                        ...
                                        <td className={style.td+' '+style.text} style={{width: '75%'}}>김선애 전도사</td>
                                    </tr>
                                    <tr> 
                                        <td className={style.td+' '+style.text2} rowSpan='1'>예배 장소</td>
                                        <td className={style.td+' '+style.text} style={{width: '75%'}}>본관 1층</td>
                                    </tr>
                                    <tr> 
                                        <td className={style.td+' '+style.text2} rowSpan='1'>예배 대상</td>
                                        <td className={style.td+' '+style.text} style={{width: '75%'}}>4살 - 초등 1학년</td>
                                    </tr>
                            </tbody>
                    </table>
                </div>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>유치유년부</span>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>오미애 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='3'>교사</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>최봉희</td>
                                </tr>
                                <tr>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>김수희</td>
                                </tr>
                                <tr>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>조재현</td>
                                </tr>
                        </tbody>
                </table>
                </div>
                ...
                <div style={{width:'100%', float: 'left', marginBottom: '30px'}}>
                    ...
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <br></br>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>2020년 유치, 유년부에서는 1주일에 한 시간 교회 안에서의 예배뿐만 아니라, 우리 각 가정에서 부모님과 함께 예배드리며 나아갑니다.</span>
                        <br></br>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>교회와 가정이 함께 합력해서 아이들이 하나님을 만나고 말씀으로 더욱 자라가며 믿음의 가정으로 세워 나가는데 힘쓰고 있습니다.</span>
                    </div>
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>2) 성경 말씀을 암송하는 어린이</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>3) 부모님과 함께 가정에서 예배드리는 어린이</span>
                    <br></br>
                    </div>
                </div>
