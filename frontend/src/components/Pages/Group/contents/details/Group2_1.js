        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width:'100%', float: 'left'}}>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%',marginRight: '5%', marginTop: '10px', float:'left'}}>
                            <tbody>
                                    ...
                                    <tr> 
                                        <td className={style.td+' '+style.text2} rowSpan='1'>총여전도 회장</td>
                                        <td className={style.td+' '+style.text} style={{width: '75%'}}>김정심 권사</td>
                                    </tr>
                                    <tr> 
                                        <td className={style.td+' '+style.text2} rowSpan='1'>총여전도 총무</td>
                                        <td className={style.td+' '+style.text} style={{width: '75%'}}>장영숙 권사</td>
                                    </tr>
                            </tbody>
                    </table>
                </div>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>에녹부</span>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    ...
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>서정수 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>부장</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>황분옥 장로</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>총무</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>탁금자 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>회계</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>진을희 권사</td>
                                </tr>
                        </tbody>
                </table>
                </div>
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>한나 여전도회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={image1} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                <div style={{width: '50%', float: 'left', height: '415px', paddingTop: '40px'}}>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>회장</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>정민자 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>총무</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>신춘자 권사</td>
                                </tr>
                                <tr> 
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>제 1여전도회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={image1} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>제 2여전도회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={image1} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                <div style={{width: '50%', float: 'left', height: '415px', paddingTop: '40px'}}>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>회장</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>장순진 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>부회장</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>송윤자 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>총무</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>이란옥 권사</td>
                                </tr>
                        </tbody>
                </table>
                </div>
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>제 3여전도회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={image1} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                <div style={{width: '50%', float: 'left', height: '415px', paddingTop: '40px'}}>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>회장</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>최봉희 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>총무</td>
                ...
                <div style={{width:'100%', float: 'left', marginBottom: '30px'}}>
                    ...
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>2) 말씀 안에서 다음세대 세우기(엡5: 27)</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>3) 말씀 안에서 신앙 세우기(느2: 17)</span>
                    </div>
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>2) 전교인 성경 읽기</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>3) 전교인 기도에 힘쓰기</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>4) 전교인 전도하기</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>5) 전교인 서로 사랑으로 섬기기</span>
                        <br></br>
                        <span className={style.text2} style={{fontSize: '20px'}}>6) 전교인 헌신/봉사하기</span>
                    <br></br>
                    </div>
                </div>
