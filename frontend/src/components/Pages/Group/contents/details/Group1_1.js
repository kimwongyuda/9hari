...
import Group_1_1 from '../../../../../images/Group_1_1.jpg'
import Group_1_2 from '../../../../../images/Group_1_2.JPG'
        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width:'100%', float: 'left'}}>
                    <span className={style.textb2} style={{fontSize: '30px', color: '#005bab'}}>남선교회 소개</span>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.textb2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>제 1남선교회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={Group_1_2} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    ...
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>김무령 장로</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>부회장</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>전병철 장로</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>총무</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>김진환 집사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>서기</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>김종택 집사</td>
                                </tr>
                                <tr> 
                ...
                <div style={{width: '100%', float: 'left', marginBottom: '30px'}}>
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.textb2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>제 2남선교회</span>
                    <div style={{width:'100%', float: 'left', marginTop: '10px',marginBottom: '10px'}}>
                    <img src={Group_1_1} style={{width: '92%', objectFit: 'fill', marginRight: '4%', marginLeft: '4%', marginBottom: '10px'}}></img>
                    </div>
                </div>
                <div style={{width: '50%', float: 'left', height: '415px', paddingTop: '40px'}}>
                    <span className={style.textb2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>섬기는 사람들</span>
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                ...
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>서기</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>이재길 집사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>회계</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>이재길 집사</td>
            ...
            content = 
            <div>
                <Pagination props={{type: '남선교회', pageindex: 1}}></Pagination>
            </div>
        }
