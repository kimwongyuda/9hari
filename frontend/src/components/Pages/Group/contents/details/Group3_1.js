        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width:'100%', float: 'left'}}>
                    <span className={style.textb2} style={{fontSize: '30px', color: '#005bab'}}>3040 선교회 소개</span>
                    <table className={style.table} style={{width: '90%', marginLeft: '5%',marginRight: '5%', marginTop: '30px', float:'left'}}>
                            <tbody>
                                    <tr> 
                                        <td className={style.td+' '+style.textb2} rowSpan='1'>3040 성경 공부 지도</td>
                                        <td className={style.td+' '+style.textb} style={{width: '75%'}}>이태규 목사</td>
                                    </tr>
                            </tbody>
                    </table>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.textb2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>3040 모임</span>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>정종육 집사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>서기</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>김민정 집사</td>
                                </tr>
                                <tr> 
