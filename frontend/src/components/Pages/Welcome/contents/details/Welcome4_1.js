                ...
                <div className={style.box2}>
                    ...
                    <div style={{width: '100%', float: 'left', paddingBottom: '20px', borderBottom: '0.1px solid #DCDCDC', marginBottom: '20px'}}>
                        ...
                        <span className={style.textb} style={{fontSize: '15px'}}>
                            ...
                            <br></br>
                            <br></br>
                            둘째아들을 뇌수종이란 병으로 잃고 예수님을 다시 영접하면서 평신도의 삶으로 노량진교회를 섬겼습니다.
                            <br></br>
                            교회에서 열정적인 신앙 생활하는 모습을 보신 노량진 교회 강신원 목사님 권유로 신학을 공부하게 되었습니다.
                            <br></br>
                            <br></br>
                            이후 서울 장신대학과 장로회 신학대학원을 졸업하고 장로회 신학대학교 목회 전문 대학원에서 목회 상담학 전공을 했습니다.
                            <br></br>
                            <br></br>
                            노량진 교회 평신도 시절부터 전도 왕으로 인정받아 전국 각지와 세계로 간증 집회 다닐 정도로 유명했습니다.
                            <br></br>
                            <br></br>
                            과천 교회 전도사와 부목사로 12년 사역을 하면서 전국 각지의 전도 팀에게 전도 법을 가르치며 전도 중 겪었던 감동적인 간증들을 전하며 전도 열매를 맺게 했습니다.
                            <br></br>
                            <br></br>
                            노량진 교회 부목사로 2년 5개월 사역하면서 부교역자 훈련을 마치고
                            <br></br>
                            2009년 12월에 현재 구하리 교회 부지인 280평을 매입하여 480평 성전 건축을 주님과 함께 혼자서 성전 건축을 했습니다.
                            <br></br>
                            2010년 12월 10일에 입당예배를 드리고 1명부터 개척하여 오늘에 이르렀습니다.
                            <br></br>
                            <br></br>
                            저서로는
                            <br></br>
