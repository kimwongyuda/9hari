        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.text2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>구하리 카페</span>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    ...
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>최혜숙 권사</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.text2} rowSpan='1'>부원</td>
                                    <td className={style.td+' '+style.text} style={{width: '75%'}}>이선영 집사</td>
                                </tr>
                        </tbody>
                </table>
                </div>
