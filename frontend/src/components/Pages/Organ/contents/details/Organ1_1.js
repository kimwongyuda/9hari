        ...
        if(page == '1'){
            ...
            <div>
                ...
                <div style={{width:'100%', float: 'left', marginBottom: '30px'}}>
                    <span className={style.textb2} style={{fontSize: '30px', color: '#005bab'}}>구하리 학원 소개</span>
                </div>
                ...
                <div style={{width: '50%', float: 'left', borderTop: '0.1px solid #DCDCDC', borderLeft: '0.1px solid #DCDCDC', borderRight: '0.1px solid #DCDCDC', borderBottom: '0.1px solid #DCDCDC'}}>
                    <span className={style.textb2} style={{marginTop: '10px', textAlign: 'center' ,width: '100%',fontSize: '20px', color: 'black', display: 'inline-block'}}>구하리 학원</span>
                ...
                <div style={{width: '50%', float: 'left', height: '415px', paddingTop: '40px'}}>
                    ...
                    <table className={style.table} style={{width: '90%', marginLeft: '5%', marginTop: '10px'}}>
                        <tbody>
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='1'>지도</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>이기영 전도사</td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                    <td className={style.td+' '+style.textb2} rowSpan='2'>교사</td>
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>한규희</td>
                                </tr>
                                <tr> 
                                    <td className={style.td+' '+style.textb} style={{width: '75%'}}>나애리</td>
                                </tr>
                        </tbody>
                </table>
                </div>
